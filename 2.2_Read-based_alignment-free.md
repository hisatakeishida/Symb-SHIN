...
- Genomes we used include
  ...
  - _Effernium_: _Effernium voratum_ RCC1521 (Shah et al., 2023)
...
- kraken2-based community profiling using custom database containing 20 Symbiodiniaceae genomes. These include assemblies of
  - Symbiodinium	microadriaticum (Nand et al., 2021), S. natans (Gonzalez-Pech et al., 2021), S. necroappetens (Gonzalez-Pech et al., 2021), S. pilosum (Gonzalez-Pech et al., 2021), S. tridacnidorum (Gonzalez-Pech et al., 2021), Symbiodinium sp. A4 (S. 'linucheae'; Gonzalez-Pech et al., 2021)
  - Breviolum	minutum (Shoguchi et al., 2013)
  - Cladocopium proliferum (Chen et al., 2022) , Cladocopium sp. C15 (Robbins et al., 2019), Cladocopium sp. C92 (Shoguchi et al., 2018)
  - Durusdinium trenchii (Shoguchi et al., 2020; Dougan et al 2023)
  - Effrenium voratum (Shah et al., 2023)
  - Fugacium kawagutii (Liu et al., 2018)
